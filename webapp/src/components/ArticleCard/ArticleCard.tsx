import { ActionIcon, Avatar, Badge, Card, Center, Group, Image, Text, rem, useMantineTheme } from '@mantine/core';
...
function ArticleCard(props: ArticleCardProps) {
    ...
    return (
        <Card withBorder radius="md" className={classes.card}>
            ...
            <Text fz="sm" c="dimmed" lineClamp={4} dangerouslySetInnerHTML={{ __html: text }}>
